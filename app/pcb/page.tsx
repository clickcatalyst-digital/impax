    ...
    <div className="space-y-7 print:space-y-2">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl print:text-base">Blank PCB</h1>
          <p className="mt-1 text-sm text-muted-foreground print:hidden">Manage PCB inventory, quantities, and movements.</p>
        </div>
